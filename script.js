...
const tableData = [
    ...
    "F", "Fluorine", "18.998403", 17, 2, "Ne", "Neon", "20.1797", 18, 2,
    "Na", "Sodium", "22.98976", 1, 3, "Mg", "Magnesium", "24.305", 2, 3,
    "Al", "Aluminium", "26.981538", 13, 3, "Si", "Silicon", "28.0855", 14, 3,
    "P", "Phosphorus", "30.973762", 15, 3, "S", "Sulfur", "32.065", 16, 3,
    "Cl", "Chlorine", "35.453", 17, 3, "Ar", "Argon", "39.948", 18, 3,
    "K", "Potassium", "39.0983", 1, 4, "Ca", "Calcium", "40.078", 2, 4,
    ...
    "Ga", "Gallium", "69.723", 13, 4, "Ge", "Germanium", "72.64", 14, 4,
    ...
    "Nb", "Niobium", "92.90638", 5, 5, "Mo", "Molybdenum", "95.96", 6, 5,
    ...
    "Cs", "Cesium", "132.90545", 1, 6, "Ba", "Barium", "137.327", 2, 6,
    "La", "Lanthanum", "138.90547", 3, 9, "Ce", "Cerium", "140.116", 4, 9,
    "Pr", "Praseodymium", "140.90765", 5, 9, "Nd", "Neodymium", "144.242", 6, 9,
    "Pm", "Promethium", "145", 7, 9, "Sm", "Samarium", "150.36", 8, 9,
    "Eu", "Europium", "151.964", 9, 9, "Gd", "Gadolinium", "157.25", 10, 9,
    "Tb", "Terbium", "158.92535", 11, 9, "Dy", "Dysprosium", "162.5", 12, 9,
    "Ho", "Holmium", "164.93032", 13, 9, "Er", "Erbium", "167.259", 14, 9,
    "Tm", "Thulium", "168.93421", 15, 9, "Yb", "Ytterbium", "173.054", 16, 9,
    "Lu", "Lutetium", "174.9668", 17, 9, "Hf", "Hafnium", "178.49", 4, 6,
    ...
    "Ac", "Actinium", "227", 3, 10, "Th", "Thorium", "232.03806", 4, 10,
    "Pa", "Protactinium", "231.03588", 5, 10, "U", "Uranium", "238.02891", 6, 10,
    "Np", "Neptunium", "237", 7, 10, "Pu", "Plutonium", "244", 8, 10,
    "Am", "Americium", "243", 9, 10, "Cm", "Curium", "247", 10, 10,
    "Bk", "Berkelium", "247", 11, 10, "Cf", "Californium", "251", 12, 10,
    "Es", "Einsteinium", "252", 13, 10, "Fm", "Fermium", "257", 14, 10,
    "Md", "Mendelevium", "258", 15, 10, "No", "Nobelium", "259", 16, 10,
    "Lr", "Lawrencium", "262", 17, 10, "Rf", "Rutherfordium", "267", 4, 7,
    "Db", "Dubnium", "268", 5, 7, "Sg", "Seaborgium", "271", 6, 7,
    "Bh", "Bohrium", "272", 7, 7, "Hs", "Hassium", "270", 8, 7,
    "Mt", "Meitnerium", "276", 9, 7, "Ds", "Darmstadtium", "281", 10, 7,
...
function init() {
    ...
    for (let i = 0; i < tableData.length; i += 5) {
        ...
        const atomicNumber = Math.floor(i / 5) + 1;
        
        // Categorías
        if ([1, 6, 7, 8, 15, 16, 34].includes(atomicNumber)) element.classList.add('nonmetal');
        else if ([2, 10, 18, 36, 54, 86, 118].includes(atomicNumber)) element.classList.add('noble-gas');
        else if ([9, 17, 35, 53, 85, 117].includes(atomicNumber)) element.classList.add('halogen');
        else if ([3, 11, 19, 37, 55, 87].includes(atomicNumber)) element.classList.add('alkali');
        else if ([4, 12, 20, 38, 56, 88].includes(atomicNumber)) element.classList.add('alkaline');
        else if (atomicNumber >= 57 && atomicNumber <= 71) element.classList.add('lanthanide');
        else if (atomicNumber >= 89 && atomicNumber <= 103) element.classList.add('actinide');
        else if ([5, 14, 32, 33, 51, 52].includes(atomicNumber)) element.classList.add('metalloid');
        else if ([13, 31, 49, 50, 81, 82, 83, 84].includes(atomicNumber)) element.classList.add('post-transition');
        else element.classList.add('transition-metal');
        ...
        target.position.x = (tableData[i + 3] * 140) - 1330;
        target.position.y = -(tableData[i + 4] * 180) + 990;
    ...
    document.getElementById('close-panel').addEventListener('click', (e) => {
        ...
        // 1. Escondemos el panel
        document.getElementById('info-panel').classList.add('hidden');
        
        // 2. Quitamos la selección de cualquier elemento (vuelven a su estado normal)
        objects.forEach(obj => obj.element.classList.remove('selected'));
    });
...
function showPanel(data) {
    ...
    document.getElementById('panel-symbol').textContent = data.symbol;
    document.getElementById('panel-name').textContent = data.name;
    document.getElementById('panel-mass').textContent = data.mass;
    document.getElementById('panel-type').textContent = (data.type || "Element").replace('-', ' ').toUpperCase();
